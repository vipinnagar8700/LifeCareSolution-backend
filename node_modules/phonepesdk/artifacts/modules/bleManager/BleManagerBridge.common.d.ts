import { BleManagerBridgeContract } from './BleManagerBridgeContract';
...
export declare class CommonPPBleManager implements BleManagerBridgeContract {
    ...
    requestMTU(peripheralId: string, _mtu: string): Promise<any>;
}
