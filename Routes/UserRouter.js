...
router.get('/AllCategory',authenticateToken, AllCategory)
...
router.post('/AddSpecialitiess',authenticateToken, AddSpecialitiess)
router.get('/AllSpecialitiess', AllSpecialitiess)
router.delete('/deleteSpecialities/:id',authenticateToken, deleteSpecialities)
router.post('/Addfeaturess',authenticateToken, Addfeaturess)
...
router.post('/AddDependents',authenticateToken, AddDependents)
...
router.get('/AllFavourates',authenticateToken, AllFavourates)
